            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="row" ng-controller="SearchItemCtrl">
                        ...
                        <div class="col-md-9">
                            {{ Form::open(array('url' => '/sales/edit/'.$sale->id, 'class' => 'form-horizontal')) }}
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="invoice" class="col-sm-3 control-label">{{trans('sale.invoice')}}</label>
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="invoice" value="{{$sale->id}}" readonly/>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        {{ Form::select(__('payment_type'), ['Cash' => __('Cash'), 'Check' => __('Check'), 'DebitCard' => __('Debit Card'), 'CreditCard' => __('Credit Card')], $sale->payment_type, array('class' => 'form-control','placeholder'=>__('Select a payment type'),'required')) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
